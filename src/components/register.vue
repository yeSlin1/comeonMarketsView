            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td><input type="text" id="username"   v-model="User.loginname"  class="text" maxlength="20"  >
                    <span   id="usernameIsExist"></span></td>
                </tr>
                <tr>
                  <th><span class="requiredField">*</span>密&nbsp;&nbsp;码:</th>
                  <td><input type="password" id="password"  v-model="User.password"  class="text" maxlength="20"   autocomplete="off">
                  </td>
                </tr>
                <tr>
                  <th><span class="requiredField">*</span>确认密码:</th>
                  <td><input type="password" id="repassword" v-on:blur="checkpassword"   v-model="repassword"      class="text" maxlength="20" autocomplete="off">
                  </td>
                </tr>
                <tr>
                  <th><span class="requiredField">*</span>E-mail:</th>
                  <td><input type="text" id="email"  v-model="User.email" class="text" maxlength="200">
                  </td>
                </tr>
                <tr>
                  <th>姓名:</th>
                  <td><input type="text"  v-model="User.username"  class="text"   maxlength="200">
                  </td>
                </tr>

                <tr>
                  <th><span class="requiredField">*</span>联系电话:</th>
                  <td><input type="text" id="phone"  v-model="User.phone"    class="text" />
                  </td>
                </tr>

                <tr>
                  <th>地址:</th>
                  <td><input type="text"  class="text"  v-model="User.address"    maxlength="200" />
                  </td>
                </tr>
                <tr>
                  <th>&nbsp;</th>
                  <td><input type="button" v-on:click="submit" class="submit" value="同意以下协议并注册" />
                  </td>
                </tr>
                <tr>
                  <th>&nbsp;</th>
...
export default {
  ...
  data () {
    ...
    submit: function (event) {
      ...
      this.$ajax.post('http://localhost:9090/user/save',params );
      // this.$ajax({
      //     method:"post",
      //     url:"http://localhost:8080/TestWeb/control",
      //     data:params
      //   })
...
div.register .submit {
	...
	border: none;
	background: url(../assets/register.gif) 0px 0px no-repeat;
}
